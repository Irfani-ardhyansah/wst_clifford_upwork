...
<head>
  ...
  <title>Efficiency Audits — Water Solutions Technology</title>
...
<nav>
  <a href="/" class="nav-logo-wrap">
    <!-- WST logo — blue bubbles + green slash -->
    <svg width="56" height="30" viewBox="0 0 56 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="13" cy="17" r="12" fill="url(#wl-lg)"/>
      <circle cx="28" cy="22" r="8.5" fill="url(#wl-md)"/>
      <circle cx="33" cy="10" r="8" fill="url(#wl-nv)"/>
      <circle cx="41" cy="21" r="4" fill="url(#wl-sm)"/>
      <line x1="47" y1="3" x2="42" y2="27" stroke="#1f6b3a" stroke-width="1.5" stroke-linecap="round"/>
      <defs>
        <radialGradient id="wl-lg" cx="33%" cy="28%" r="65%"><stop offset="0%" stop-color="#b8e6f8"/><stop offset="100%" stop-color="#5aaee0"/></radialGradient>
        <radialGradient id="wl-md" cx="33%" cy="33%" r="65%"><stop offset="0%" stop-color="#9ad4f2"/><stop offset="100%" stop-color="#4aa0d4"/></radialGradient>
        <radialGradient id="wl-nv" cx="28%" cy="24%" r="70%"><stop offset="0%" stop-color="#5262ea"/><stop offset="100%" stop-color="#1c2bac"/></radialGradient>
        <radialGradient id="wl-sm" cx="38%" cy="33%" r="60%"><stop offset="0%" stop-color="#d0eef8"/><stop offset="100%" stop-color="#88c8e8"/></radialGradient>
      </defs>
    </svg>
    <div class="nav-logo-text">
      <span class="nav-logo-name">Water Solutions Technology</span>
      <span class="nav-logo-sub">An end-to-end water management solution</span>
    </div>
  </a>
  ...
  <ul class="nav-links">
    ...
    <li>
      ...
      <div class="dropdown">
        ...
        <a href="/services/feasibility">Feasibility Assessment</a>
        ...
        <a href="/services/gresb">GRESB Compliance &amp; Strategy</a>
      </div>
    </li>
  ...
  <div class="nav-right">
    ...
    <a href="https://member.watersolutech.com" class="nav-icon-btn" aria-label="Member Login">
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="8" cy="5.5" r="3"/><path d="M2 14c0-3.31 2.69-6 6-6s6 2.69 6 6"/></svg>
    </a>
    <a href="/contact" class="nav-cta">Speak with an Advisor</a>
  </div>
</nav>
...
<div class="inner-hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-cta-row">
      <a href="/contact" class="hero-btn-primary">Speak With an Auditor</a>
...
<section class="sec sec-o" id="how-it-works">
  <div class="two">
    ...
    <div class="bm">
      ...
      <a href="/contact" class="bm-cta">Request a Water Audit</a>
    </div>
  </div>
</section>
  ...
  <div class="validate-grid">
    ...
    <div>
      <div class="insights-guide">
        ...
        <a href="/resources/white-papers" class="guide-btn">
          Download Now
...
<section class="sec sec-o">
  <div class="price-grid">
    <div>
      ...
      <a href="/resources/webinars" style="font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:var(--green-lt);text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
  ...
  <div class="footer-main">
    <div>
      ...
      <div class="footer-address">
        ...
        <a href="/cdn-cgi/l/email-protection#c0a1a3a380b7a1b4a5b2b3afacb5b4a5a3a8eea3afad"><span class="__cf_email__" data-cfemail="ea8b8989aa9d8b9e8f989985869f9e8f8982c4898587">[email&#160;protected]</span></a>
      </div>
    ...
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="/opportunities/servicers">Careers &amp; Partners</a></li>
    ...
    <div>
      ...
      <ul class="footer-links">
        ...
        <li><a href="/resources/gresb-tool">GRESB Peer Tool</a></li>
        ...
        <li><a href="/resources/financing">Financing Application</a></li>
      </ul>
...
<div class="sticky-cta" id="sticky-cta">
  <div class="sticky-cta-text">
    <strong>Ready to see your portfolio's water exposure?</strong>
    &nbsp;A 90-minute assessment with WST &mdash; no obligation.
  </div>
  <div class="sticky-cta-actions">
    <a href="/contact" class="sticky-cta-btn">Schedule Assessment</a>
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>
  ...
  const footerYr = document.getElementById('footer-yr');
  if (footerYr) footerYr.textContent = yr;
  document.querySelectorAll('.current-year').forEach(el => { el.textContent = yr; });
  ...
  window.addEventListener('scroll', () => {
    ...
    if (navEl) navEl.style.boxShadow = scrolled > 20 ? '0 4px 24px rgba(0,0,0,0.09)' : '0 1px 4px rgba(0,0,0,0.04)';
    if (stickyCta) stickyCta.classList.toggle('visible', scrolled > window.innerHeight * 0.7);
  });
  if (dismissBtn && stickyCta) dismissBtn.addEventListener('click', () => stickyCta.style.display = 'none');
