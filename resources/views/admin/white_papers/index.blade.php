                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center 
                                    ...
                                    <h3 class="text-xl font-bold text-[var(--text-1)] mb-2">No Case Studies Yet</h3>
                                    <p class="text-[var(--text-3)] mb-6">Get started by adding your first project showcase to the portfolio.</p>
